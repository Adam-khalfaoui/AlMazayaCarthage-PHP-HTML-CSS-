    ...
    <section class="contact-section">
            <div class="container">
                <div class="d-none d-sm-block mb-5 pb-4">
                    ...
                    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAbARhlIUSNoDepXf3O3b1bvdA49sqV2Ig&callback=initMap">
                    </script>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>+974 4441 5400</h3>
                                <p>SUN to THU 12am to 1pm</p>
								<p>FRI AND SAT 7am to 1pm</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>almazaya@carthage.com</h3>
